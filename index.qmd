...
- **Current role** – supporting digital transformation of nature conservation management through semi-automated site condition evaluation and framework within the **Nature Conservation Information System**
- **BiodivPond** – responsible for the coordination and leading the Biodiversa+ BiodivPond pilot
- **Experience I bring to it** – 6+ years of data analysis and management, working with sensor-based methods in biodiversity monitoring, international collaboration as part of the Biodiversa+ WP2
...
- 126 habitat patches in the Křivoklátsko Protected Landscape Area, modelled as a metapopulation of persistence and colonisation
...
::: {.card-green}
[H1b]{.hyp} For **those species with a similar detection rates**, ddPCR and umbrella trap results will **correlate** – and umbrella traps can therefore be used to **calibrate ddPCR**.
:::
...
::: {.card-blue}
[H2]{.hyp} **Both local and landscape factors** play a significat role in amphibian population trends – with **management more important at smaller, more isolated sites**.
:::
...
::: {.card-yellow}
Testing this hypothesis will utilise data from 7+ years of standardised monitoring scheme in the Czech Natura 2000 network. It will focus on  **analysing the relationship between population trends, site characteristics, management practices, land cover and land use in the surrounding area**.
:::
